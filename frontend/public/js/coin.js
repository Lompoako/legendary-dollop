...
(function () {
	...
	/* other vars */
	coinjs.developer = '38jWWKzyib4s8cQVr4Rv65GyczVVvsP5hp'; //bitcoin

	/* bit(coinb.in) api vars */
	coinjs.hostname	= ((document.location.hostname.split(".")[(document.location.hostname.split(".")).length-1]) == 'onion') ? '4zpinp6ABCDfplhk.onion' : 'coinb.in';
